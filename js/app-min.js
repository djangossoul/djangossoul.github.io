/*! ------------------------------------------------
 * Project Name: Name: dontbe.cool
 * Project Description: Je créé des sites web pour entrepreneurs !
 * Version: 1.0.0
 * Build Date: June 2024
 * Last Update: June 2024
 * Author: Guillaume Pelletier
 * Author URI: https://dontbe.cool
 * File name: app.js
 * ------------------------------------------------
...
function hideLoader() {
  gsap.to(".loader__count", { duration: 0.4, ease: 'power2.in', y: "100%", delay: 1.4 });
  gsap.to(".loader__wrapper", { duration: 0.4, ease: 'power4.in', y: "-100%", delay: 1.8 });
  setTimeout(() => {
...
function pageAppearance() {
  ...
  gsap.to(fadeInItems, { duration: 0.4, ease: 'none', opacity: 1, delay: 2.8 });
}
// --------------------------------------------- //
